              ...
              @can('admin')
                <div class="d-flex justify-content-end">
                  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-primary">
                    <i class="material-icons" style="font-size:14px">person_add</i> Tambah Nasabah
                  </button>
                </div>
              @endcan
            </div>
                    ...
                    <td class="text-right py-0 align-middle">
                      <div class="btn-group btn-group-sm">
                        ...
                        @can('admin')
                          ...
                          <a href="{{ route('delete.user', [ 'user_id' => $nasabah->id ]) }}" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                        @endcan
                      </div>
                    </td>
                  </tr>
              ...
              <div class="modal-content bg-primary">
                ...
                <div class="modal-body">
                      ...
                      <form method="POST" action="{{ route('tambah.user') }}" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="user_role" value="nasabah">
